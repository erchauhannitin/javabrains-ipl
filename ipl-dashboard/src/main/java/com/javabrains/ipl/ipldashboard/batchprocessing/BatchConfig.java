...
public class BatchConfig {
    ...
    public FlatFileItemReader<MatchInput> reader() {
        return new FlatFileItemReaderBuilder<MatchInput>().name("matchDataReader").linesToSkip(1)
    ...
    public JdbcBatchItemWriter<MatchData> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<MatchData>()
                ...
                .sql("INSERT INTO MATCH_DATA (id, city, date, player_of_match, venue, team1, team2, toss_winner, toss_decision, winner, result, result_margin, umpire1, umpire2"
