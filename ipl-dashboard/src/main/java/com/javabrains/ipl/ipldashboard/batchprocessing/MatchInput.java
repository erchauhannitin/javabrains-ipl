...
public class MatchInput {
  ...
  public MatchInput(String id, String city, String date, String player_of_match, String venue, String neutral_venue, String team1,
      String team2, String toss_winner, String toss_decision, String winner, String result, String result_margin,
  ...
  public String toString() {
    return "MatchInput [city=" + city + ", date=" + date + ", eliminator=" + eliminator + ", id=" + id + ", method="
        + method + ", neutral_venue=" + neutral_venue + ", player_of_match=" + player_of_match + ", result=" + result
        + ", result_margin=" + result_margin + ", team1=" + team1 + ", team2=" + team2 + ", toss_decision="
        + toss_decision + ", toss_winner=" + toss_winner + ", umpire1=" + umpire1 + ", umpire2=" + umpire2 + ", venue="
        + venue + ", winner=" + winner + "]";
  }
